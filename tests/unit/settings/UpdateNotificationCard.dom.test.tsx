/**
 * @license
 * Copyright 2026 RickyTicky BobbyWobbin (aionui.com)
...
describe('UpdateNotificationCard', () => {
  beforeEach(() => {
    ...
    mocks.updateCheckMock.mockResolvedValue({
      ...
      data: {
        ...
        latest: {
          ...
          name: 'v2.1.14',
          body: 'notes',
          htmlUrl: 'https://github.com/iOfficeAI/RickyTicky-BobbyWobbin/releases/tag/v2.1.14',
          prerelease: false,
          draft: false,
          assets: [],
          recommendedAsset: {
            name: 'RickyTicky BobbyWobbin-2.1.14-mac-arm64.dmg',
            url: 'https://static.rickyticky-bobbywobbin.com/releases/2.1.14/RickyTicky BobbyWobbin-2.1.14-mac-arm64.dmg',
            fallbackUrl: 'https://github.com/iOfficeAI/RickyTicky-BobbyWobbin/releases/download/v2.1.14/RickyTicky BobbyWobbin-2.1.14-mac-arm64.dmg',
            size: 123,
          },
        },
      },
    ...
    mocks.updateDownloadMock.mockImplementation(async (request: UpdateDownloadRequest) => ({
      ...
      data: {
        ...
        file_path: '/tmp/RickyTicky BobbyWobbin-2.1.14-mac-arm64.dmg',
      },
    }));
  });
  ...
  it('restores a cached completed auto-update on mount', async () => {
    mocks.autoUpdateRestoreDownloadedMock.mockResolvedValue({
      ...
      data: {
        ready: true,
        version: '2.1.14',
        filePath: '/cache/pending/RickyTicky BobbyWobbin-2.1.14-mac.zip',
      },
    });
  ...
  it('shows consumed silent installer failure marker with retry, log, and feedback actions', async () => {
    const marker: InstallerLastFailureMarker = {
      ...
      updated: true,
      retryCount: 3,
      instDir: 'D:\\RickyTicky BobbyWobbin',
