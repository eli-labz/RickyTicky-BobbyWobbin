...
describe('updateBridge manual download dedupe', () => {
  ...
  it('reuses the active manual download for the same URL, fallback URL, and file name', async () => {
    ...
    const request = {
      url: 'https://static.rickyticky-bobbywobbin.com/releases/2.2.0/RickyTicky BobbyWobbin-2.2.0-mac-arm64.dmg',
      fallbackUrl: 'https://github.com/iOfficeAI/RickyTicky-BobbyWobbin/releases/download/v2.2.0/RickyTicky BobbyWobbin-2.2.0-mac-arm64.dmg',
      file_name: 'RickyTicky BobbyWobbin-2.2.0-mac-arm64.dmg',
    };
