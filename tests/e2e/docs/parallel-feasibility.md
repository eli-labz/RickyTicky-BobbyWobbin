...
- Dev mode: `~/Library/Application Support/RickyTicky BobbyWobbin-Dev/` (macOS)
...
2. Modify `getDevAppName()` to return worker-specific name:
   ...
   return `RickyTicky BobbyWobbin-E2E-Worker-${workerId}`;
   ```
3. Each worker gets isolated:
   - `~/Library/Application Support/RickyTicky BobbyWobbin-E2E-Worker-0/config/aionui.db`
   - `~/Library/Application Support/RickyTicky BobbyWobbin-E2E-Worker-1/config/aionui.db`
