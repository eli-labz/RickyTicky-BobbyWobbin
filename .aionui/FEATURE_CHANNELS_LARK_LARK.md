...
2. 用户可通过飞书机器人与 RickyTicky BobbyWobbin 进行对话
...
│   版本管理与发布 → 创建版本 → 申请发布                      │
├─────────────────────────────────────────────────────────────┤
│ Step 5: 配置 RickyTicky BobbyWobbin                                         │
...
| ------------ | ------------------------------ |
| 配对码认证   | 6位随机码，10分钟有效          |
| 本地批准     | 必须在 RickyTicky BobbyWobbin 中批准，非飞书中 |
| 用户白名单   | 仅授权用户可使用               |
| 速率限制     | 防止滥用                       |
...
- [ ] 配对码 10 分钟过期
- [ ] 必须在 RickyTicky BobbyWobbin 本地批准
- [ ] 未授权用户无法使用
- [ ] App Secret 加密存储
- [ ] 速率限制生效
...
- **创建日期**: 2026-01-30
- **最后更新**: 2026-01-30
- **适用版本**: RickyTicky BobbyWobbin v0.x+
- **维护者**: 项目团队
