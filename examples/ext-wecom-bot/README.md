...
Enterprise WeCom AI Bot channel extension example for RickyTicky BobbyWobbin.
...
- Bridging inbound message to RickyTicky BobbyWobbin unified channel pipeline
