...
function getLogFilePath(): string {
  ...
  // Dev mode uses "RickyTicky BobbyWobbin-Dev", production uses "RickyTicky BobbyWobbin"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'RickyTicky BobbyWobbin-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'RickyTicky BobbyWobbin', `${today}.log`);
