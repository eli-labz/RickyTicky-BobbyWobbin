#!/usr/bin/env bash
# ============================================================================
# RickyTicky BobbyWobbin WebUI — One-Click Installation Script
# ============================================================================
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/iOfficeAI/RickyTicky-BobbyWobbin/main/scripts/install-web.sh | bash
#   # Or specify version:
...
MIRROR="${MIRROR:-https://github.com/iOfficeAI/RickyTicky-BobbyWobbin/releases/download}"
...
banner() {
    echo -e "${CYAN}${BOLD}"
    echo "  ╔══════════════════════════════════════════════╗"
    echo "  ║     RickyTicky BobbyWobbin WebUI Installer (No Electron)     ║"
    echo "  ╚══════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
download_tarball() {
    ...
    # Build download URL
    # MIRROR formats:
    #   - GitHub: https://github.com/iOfficeAI/RickyTicky-BobbyWobbin/releases/download
...
print_summary() {
    ...
    echo -e "${GREEN}${BOLD}  🎉 RickyTicky BobbyWobbin WebUI v${VERSION} Installed!${NC}"
    echo -e "${GREEN}${BOLD}══════════════════════════════════════════════════${NC}"
    echo ""
    ...
    if [[ "$CREATE_SYMLINK" == "1" && ":$PATH:" == *":${BIN_DIR}:"* ]]; then
        echo "    # Start RickyTicky BobbyWobbin WebUI"
        echo "    aionui-web start"
        echo ""
        echo "    # Check version"
        echo "    aionui-web version"
    else
        echo "    # Start RickyTicky BobbyWobbin WebUI (using full path)"
    ...
    echo ""
    echo -e "  ${BOLD}📖 Documentation:${NC}  https://github.com/iOfficeAI/RickyTicky-BobbyWobbin"
    echo -e "  ${BOLD}🐛 Report issues:${NC}  https://github.com/iOfficeAI/RickyTicky-BobbyWobbin/issues"
    echo ""
