 ...
 * work on hosts that never installed RickyTicky BobbyWobbin.app, and its default work dir must
 ...
 * `~/Library/Application Support/RickyTicky BobbyWobbin-Dev/aionui` so CLI tools (claude,
...
async function main(): Promise<void> {
  ...
  // This keeps `bun run webui` fully self-contained on hosts without RickyTicky BobbyWobbin.app.
  ...
  console.log('');
  console.log('RickyTicky BobbyWobbin WebUI is ready');
