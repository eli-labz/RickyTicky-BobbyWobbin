...
for f in RickyTicky BobbyWobbin-1.0.0-win-x64.exe RickyTicky BobbyWobbin-1.0.0-win-arm64.exe RickyTicky BobbyWobbin-1.0.0-mac-x64.dmg RickyTicky BobbyWobbin-1.0.0-mac-arm64.dmg RickyTicky BobbyWobbin-1.0.0.deb RickyTicky BobbyWobbin-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
