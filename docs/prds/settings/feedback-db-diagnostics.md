...
RickyTicky BobbyWobbin owns only feedback orchestration:
...
RickyTicky BobbyWobbin main process must not read SQLite or expose `feedback:collect-db-diagnostics`.
