...
<p align="center">
  <a href="../../readme.md">English</a> | <strong>简体中文</strong> | <a href="./readme_tw.md">繁體中文</a> | <a href="./readme_jp.md">日本語</a> | <a href="./readme_ko.md">한국어</a> | <a href="./readme_es.md">Español</a> | <a href="./readme_pt.md">Português</a> | <a href="./readme_tr.md">Türkçe</a> | <a href="./readme_ru.md">Русский</a> | <a href="./readme_uk.md">Українська</a> | <a href="https://www.rickytickybobbywobbin.com" target="_blank">官方网站</a>
</p>
...
[✨ Cowork 演示](#-cowork-演示) ·
[🤔 为什么选择 RickyTicky BobbyWobbin？](#-为什么选择-rickyticky-bobbywobbin-而非-claude-cowork) ·
[🚀 快速开始](#-快速开始) ·
[💬 社区](#-社区与支持)
...
**RickyTicky BobbyWobbin 不只是个聊天工具。** 它是一个真正的 Cowork 平台，AI Agent 就像您的得力助手，在电脑上帮您处理各种任务——读文件、写代码、查资料、自动化工作流。Agent 的一举一动都在您的掌控之中，透明可见。

|                       | 传统 AI 聊天客户端 | **RickyTicky BobbyWobbin (Cowork)**                                                                                    |
| :-------------------- | :----------------- | :----------------------------------------------------------------------------------------------------- |
...
RickyTicky BobbyWobbin 自带完整的 AI Agent。不像其他工具需要你手动安装各种 CLI 工具，**RickyTicky BobbyWobbin 装好就能用，开箱即用**。
...
想把文档/表格直接交给 Agent？RickyTicky BobbyWobbin 内置 **[OfficeCLI](https://github.com/iOfficeAI/OfficeCLI)**，让 PPT（Morph 转场）、Word（`.docx`）与 Excel（`.xlsx/.xlsm/.csv`）从需求到可交付结果更高效、更稳定。
...
如果你已经在用 Claude Code、Codex、Hermes Agent 或 OpenClaw，RickyTicky BobbyWobbin 会自动发现它们，让你同时和这些 Agent 一起协作——当然，还有内置 Agent。

**支持的 Agent：** 内置 Agent（零配置） • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI（aionrs，RickyTicky BobbyWobbin 随附的 Rust 后端服务） • Snow CLI • Hermes Agent • Cursor Agent 等
