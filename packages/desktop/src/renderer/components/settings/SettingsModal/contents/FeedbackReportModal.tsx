...
const FeedbackReportModal: React.FC<FeedbackReportModalProps> = ({
  ...
  // "Solve via chat": hand the report to the RickyTicky BobbyWobbin Butler for on-the-spot
