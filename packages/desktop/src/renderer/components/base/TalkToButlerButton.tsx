...
export type TalkToButlerButtonProps = {
   ...
   * RickyTicky BobbyWobbin Butler (select it + pre-fill `prompt`). Callers that want a
 ...
 * "… via chat" (hand off to the RickyTicky BobbyWobbin Butler with a pre-filled prompt), the
