...
const Layout: React.FC<{
  ...
  // The "RickyTicky BobbyWobbin" wordmark acts as Home / Back-to-Chat, but only from settings routes.
          ...
          <ArcoLayout className={'size-full layout flex-1 min-h-0'}>
            ...
            >
              ...
              >
                ...
                >
                  <img
                    src='/rickyticky-bobbywobbin-logo.jpg'
                    alt='RickyTicky BobbyWobbin logo'
                    className={classNames('absolute inset-0 m-auto rounded-6px object-cover', {
                      'w-26px h-26px': !collapsed,
                      'w-20px h-20px': collapsed,
                    })}
                  />
                </div>
                {isSettingsRoute ? (
                  ...
                  <div className='text-16px text-t-primary collapsed-hidden font-semibold'>RickyTicky BobbyWobbin</div>
                )}
                {isMobile && !collapsed && (
                  <button
                    type='button'
