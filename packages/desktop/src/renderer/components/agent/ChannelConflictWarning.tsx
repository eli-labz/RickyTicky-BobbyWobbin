...
/**
 * Warning component when OpenClaw channel conflicts with RickyTicky BobbyWobbin Channels
 */
    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>OpenClaw is handling {platformName} messages, not RickyTicky BobbyWobbin.</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in RickyTicky BobbyWobbin will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use RickyTicky BobbyWobbin Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and RickyTicky BobbyWobbin.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for RickyTicky BobbyWobbin.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in RickyTicky BobbyWobbin Channels and continue using OpenClaw's integration.
          </Paragraph>
