...
export type AgentMetadata = {
  ...
  /** Native mode id that RickyTicky BobbyWobbin's legacy `yolo` / `yoloNoSandbox`
...
export function getManagedAgentDisplayName(agent: Pick<ManagedAgent, 'name'>): string {
  return normalizeLegacyProductCopy(agent.name);
}
