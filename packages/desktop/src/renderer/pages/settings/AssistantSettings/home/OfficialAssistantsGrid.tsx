        ...
        <span className='inline-flex min-w-0 items-center gap-6px text-12px text-t-tertiary'>
          ...
          <span className='truncate'>
            {t('settings.officialAssistantsHintShort', {
              defaultValue: 'Maintained by RickyTicky BobbyWobbin · enable to use, duplicate to customize',
            })}
          </span>
        </span>
        ...
        {officialAssistants.map((assistant) => {
          ...
          return (
            ...
            >
              ...
              >
                {normalizeLegacyProductCopy(assistant.description_i18n?.[localeKey] || assistant.description || '')}
              </div>
