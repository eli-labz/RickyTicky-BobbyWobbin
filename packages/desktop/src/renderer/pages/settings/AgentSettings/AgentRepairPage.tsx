...
import { getManagedAgentDisplayName } from '@/renderer/utils/model/agentTypes';
...
const AgentRepairPage: React.FC = () => {
  ...
  const displayName = getManagedAgentDisplayName(agent);
    ...
    <div data-testid='agent-repair-page' className='flex h-full min-h-0 flex-col overflow-hidden bg-transparent'>
      ...
      >
        <div className='flex min-w-0 flex-1 items-center gap-10px'>
          ...
          <div className='truncate text-14px font-600 text-t-primary'>{displayName}</div>
        </div>
        <Button
          type='outline'
          size='small'
