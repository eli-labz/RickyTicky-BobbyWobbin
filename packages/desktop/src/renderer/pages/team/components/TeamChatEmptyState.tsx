...
import { normalizeLegacyAssistantBranding } from '@renderer/utils/model/assistantDisplay';
...
const resolveAssistantName = (
  ...
  const trimmedExplicitName = normalizeLegacyAssistantBranding(explicitAssistantName);
  ...
  if (extraAgentName && normalizeLegacyAssistantBranding(extraAgentName)) {
    return normalizeLegacyAssistantBranding(extraAgentName);
  }
  ...
  if (role) return normalizeLegacyAssistantBranding(role) || role;
  return 'Leader';
};
