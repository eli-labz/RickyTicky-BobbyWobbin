...
const resolveAssistantDisplayName = (
  ...
  const trimmedExplicitAssistantName = normalizeLegacyAssistantBranding(explicitAssistantName);
  ...
  if (extraAgentName?.trim()) return normalizeLegacyAssistantBranding(extraAgentName) || extraAgentName.trim();
  return undefined;
};
