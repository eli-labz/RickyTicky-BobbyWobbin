...
const TeamAgentIdentity: React.FC<Props> = ({
  ...
  const displayName = normalizeLegacyAssistantBranding(assistant_name) || presetInfo?.name || 'Assistant';
  ...
  const crownIcon = (
    ...
    >
      ...
      />
      <path d='M5 10.1H11' stroke='var(--text-primary)' strokeWidth='1.1' strokeLinecap='round' />
    </svg>
  );
