 ...
 *   - macOS:   ~/Library/Logs/RickyTicky BobbyWobbin/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\RickyTicky BobbyWobbin\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/RickyTicky BobbyWobbin/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
