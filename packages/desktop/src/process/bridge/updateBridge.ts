...
const DEFAULT_REPO = 'iOfficeAI/RickyTicky-BobbyWobbin';
const DEFAULT_USER_AGENT = 'RickyTicky BobbyWobbin';
const ALLOWED_ASSET_EXTS = new Set(['.exe', '.msi', '.dmg', '.zip', '.deb', '.rpm']);
const CDN_HOST = 'static.rickyticky-bobbywobbin.com';
...
const sanitizeFileName = (name: string): string => {
  ...
  // Avoid empty names.
  return base || `RickyTicky BobbyWobbin-update-${Date.now()}`;
};
